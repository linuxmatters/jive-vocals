...
│   ├── analyser_noise_bands.go # measureNoiseBands() - Pass 1 15-band RMS spectrum of the elected room-tone region (band centres 80 Hz to 24 kHz); sets NoiseProfile.BandNoise + BandsMeasured for afftdn's custom noise profile
