...
func TestRenderMarkdownSectionOrder(t *testing.T) {
	...
	// Sections MUST appear in this exact order. The record carries no spectrogram
	// paths, so the Spectrograms slot contributes no heading; Interval Summary
	// follows Regions directly.
	order := []string{
